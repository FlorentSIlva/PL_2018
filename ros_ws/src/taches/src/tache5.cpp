...
void Tache5::FinTraitementProduit(int numTable)
{
...
void Tache5::PositionRobotCallback(const std_msgs::Int32::ConstPtr& msg)
{
	position = msg->data;
}
...
void Tache5::BrasRobotCallback(const std_msgs::Int32::ConstPtr& msg)
{
	bras = msg->data;
}
...
void Tache5::PinceRobotCallback(const std_msgs::Int32::ConstPtr& msg)
{
	pince = msg->data;
}
...
void Tache5::TraitementProduitCallback(const std_msgs::Int32::ConstPtr& msg)
{
	produit=msg->data;	
...
void Tache5::init(ros::NodeHandle noeud, std::string executionPath)
{
	...
	//Subscribers
	robotPosition = noeud.subscribe("/robot/PositionRobot3", 10, &Tache5::PositionRobotCallback, this);
	
	robotBras = noeud.subscribe("/robot/BrasRobot3",10,&Tache5::BrasRobotCallback,this);

	robotPince = noeud.subscribe("/robot/PinceRobot3",10,&Tache5::PinceRobotCallback,this);

	posteProduit = noeud.subscribe("/P5_Tache/ProduitATraiter",10,&Tache5::TraitementProduitCallback,this);


	//Publishers	
	pub_traitementProduitTache = noeud.advertise<std_msgs::Int32>("/Tache_P5/Tache5Finie",10);

	pub_retourTraitement = noeud.advertise<std_msgs::Int32>("/commande/Simulation/ProduitTraitement5",10);
...
void Tache5::initProduct(int nJobtime, int pNumber)
{
