...
if("TRUE" STREQUAL "TRUE")
  set(communication_SOURCE_PREFIX /home/projn7cellule/Working_Folder_Florent/ros_ws/src/communication)
  set(communication_DEVEL_PREFIX /home/projn7cellule/Working_Folder_Florent/ros_ws/devel)
  ...
  set(communication_INSTALL_PREFIX /home/projn7cellule/Working_Folder_Florent/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'etudiant <etudiant@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/projn7cellule/Working_Folder_Florent/ros_ws/src/communication/${idir}'.  Ask the maintainer 'etudiant <etudiant@todo.todo>' to fix it.")
    endif()
...
set(communication_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${communication_dep}_FOUND)
      find_package(${communication_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${communication_dep} REQUIRED ${depend_list})
  endif()
